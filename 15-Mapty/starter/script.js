...
//Testing
// const run1 = new Running([39, -12], 52, 74, 178);
// const cycling1 = new Cycling([39, -12], 43, 78, 523);
...
class App {
  ...
  constructor() {
    ...
    //Displays the marker after submitting the form
  ...
  _loadMap(position) {
    ...
    //Render the markers from local storage when the page loads
